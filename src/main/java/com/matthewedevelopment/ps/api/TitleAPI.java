package com.matthewedevelopment.ps.api;
...
public class TitleAPI {
    ...
    public static void sendActionBar(final Player player, final String message, int duration) {
        ...
        if (duration >= 0) {
            ...
            }.runTaskLater(PracticeServer.getPracticeServer(), duration + 1);
        }
        ...
        while (duration > 60) {
            ...
            }.runTaskLater(PracticeServer.getPracticeServer(), (long) sched);
        }
    }
