...
public class ItemBuilder implements IItemBuilder {
    ...
    @Override
    public ItemBuilder setTier(ItemTier itemTier) {
        setTag("tier", itemTier.getTierNumber());
        return (ItemBuilder) setDisplayName(itemTier.getChatColor() + getItemMeta().getDisplayName());
    }
    ...
    public IItemBuilder setTag(String key, Object value) {
        ...
        net.minecraft.server.v1_9_R2.ItemStack stack = CraftItemStack.asNMSCopy(this.itemStack);
